...
namespace Crosstales.NVorbis
{
   public class VorbisReader : IDisposable
   {
      ...
      public int Channels
      {
         get { return ActiveDecoder._channels; }
      }
      ...
      {
         get { return ActiveDecoder._sampleRate; }
      }
      ...
      {
         get { return ActiveDecoder._upperBitrate; }
      }
      ...
      {
         get { return ActiveDecoder._nominalBitrate; }
      }
      ...
      {
         get { return ActiveDecoder._lowerBitrate; }
      }
      ...
      {
         get { return ActiveDecoder._vendor; }
      }
      ...
      {
         get { return ActiveDecoder._comments; }
      }
      ...
      {
         get { return ActiveDecoder.IsParameterChange; }
      }
      ...
      {
         get { return ActiveDecoder.ContainerBits; }
      }
      ...
      public int ReadSamples(float[] buffer, int offset, int count)
      {
         ...
         int result = ActiveDecoder.ReadSamples(buffer, offset, count);

         //UnityEngine.Debug.Log (ActiveDecoder);

         if (ClipSamples)
         {
            var decoder = _decoders[_streamIdx];
            for (int i = 0; i < result; i++, offset++)
            {
      ...
      {
         get { return TimeSpan.FromSeconds((double)ActiveDecoder.CurrentPosition / SampleRate); }
      ...
      {
         get { return ActiveDecoder.CurrentPosition; }
